...
describe("01-linear-algorithms", () => {
  ...
  describe("multiplierAndSum", () => {
    ...
    it('console.log "Multi: -27, Sum: 9-3" for str and negative int', () => {
      console.log = jest.fn();
  ...
  describe("sumStringsLength", () => {
    ...
    it("console.log 281 for long strings", () => {
      console.log = jest.fn();
      sumStringsLength(
        `Lorem ipsum dolor sit, amet consectetur adipisicing elit. Saepe nemo 
        totam architecto impedit inventore?`,
        `Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
        Necessitatibus, consequatur sapiente. Minus a ab quos recusandae
        delectus. Quae, nihil error.`
      );
      // The first argument of the first call to the function was '281'
      expect(console.log.mock.calls[0][0]).toBe(281);
    });
  });
  ...
  describe("sumOfDigits", () => {
    ...
    it('console.log a number between 3 (for "111") and 27 (for "999")', () => {
      console.log = jest.fn();
      sumOfDigits();
      const range = console.log.mock.calls[0][0] >= 3 <= 27;
