...
describe("04-objects.js", () => {
  ...
  describe("addAge", () => {
    ...
    test(`returns an object with property "age" assigned to NaN 
    for a string input`, () => {
    ...
    test(`returns an object with property "age" assigned to 0 
    for empty input`, () => {
  ...
  describe("createUserObjCopy", () => {
    ...
    test(`returns an object without property "name" when no object 
    is provided`, () => {
