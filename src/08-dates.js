...
export function minutesToday() {
  ...
  const minutesTodayNum = (nowTs - todayDateTs) / 1000 / 60;

  console.log(minutesTodayNum.toFixed(0));
}
...
const bdayInput1 = "20.02.2002";
const bdayInput2 = "11.11.1111";
...
youngest(bdayInput1, bdayInput2);
